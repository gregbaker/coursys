...
class CommonProblem(models.Model):
    ...
    purge_policy = AgePurgePolicy(age_field='activity_component__numeric_activity__offering__semester__end', after_days=365*8)
...
class ActivityComponentMark(models.Model):
    ...
    purge_policy = AgePurgePolicy(age_field='activity_mark__activity__offering__semester__end', after_days=365*8)
