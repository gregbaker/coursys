...
# Experimentally, a test system worked throughout this:
# (0) have existing data (1) merge this in with its migrations (2) make new-code (3) make migrate-safe 
# ... so the mariadb treatment of CHAR(32) and UUID must be close enough either way for django.
